...
//     function getWeiCollected() external view returns (uint256);
...
//     function getTotalInvestmentsStored() external view returns (uint256);
//     /// @dev called in case crowdsale succeeded
//     function wcOnCrowdsaleSuccess() external;
//     /// @dev called in case crowdsale failed
//     function wcOnCrowdsaleFailure() external;
// }
...
//     function hasHardCap() internal view  virtual returns (bool);

//     /// @notice maximum investments to be accepted during pre-ICO
//     function getMaximumFunds() internal view virtual returns (uint256);

//     /// @notice minimum amount of funding to consider crowdsale as successful
//     function getMinimumFunds() internal view  virtual returns (uint256);

//     /// @notice start time of the pre-ICO
//     function getStartTime() internal view virtual returns (uint256);

//     /// @notice end time of the pre-ICO
//     function getEndTime() internal view virtual returns (uint256);

//     /// @notice minimal amount of investment
//     function getMinInvestment() public view virtual returns (uint256);
...
//         if (change > 0) payable(investor).transfer(change);
...
//         return 8; //getTotalInvestmentsStored();
//     }
